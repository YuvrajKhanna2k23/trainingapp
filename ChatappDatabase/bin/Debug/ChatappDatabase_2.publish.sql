...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[Messages]...';


GO
ALTER TABLE [dbo].[Messages] DROP CONSTRAINT [DF__Messages__Type__01142BA1];


GO
/*
The column [dbo].[Messages].[ReplyedToId] is being dropped, data loss could occur.
*/
GO
PRINT N'Starting rebuilding table [dbo].[Messages]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Messages] (
    [Id]             INT             IDENTITY (1, 1) NOT NULL,
    [Content]        NVARCHAR (1000) NOT NULL,
    [SenderId]       INT             NOT NULL,
    [ReceiverId]     INT             NOT NULL,
    [DateTime]       DATETIME2 (7)   NOT NULL,
    [RepliedToId]    INT             DEFAULT 0 NOT NULL,
    [RepliedContent] NVARCHAR (1000) NULL,
    [IsReply]        INT             DEFAULT 0 NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Messages])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Messages] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Messages] ([Id], [Content], [SenderId], [ReceiverId], [DateTime], [IsSeen], [IsReply], [Type])
        SELECT   [Id],
                 [Content],
                 [SenderId],
                 [ReceiverId],
        ...
        FROM     [dbo].[Messages]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Messages] OFF;
    END

DROP TABLE [dbo].[Messages];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Messages]', N'Messages';
